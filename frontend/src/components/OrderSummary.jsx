        ...
        {customerData.customerName && (
          <div>
            ...
            <div className="text-sm text-gray-900">
              ...
              {customerData.phone && (
                <div className="text-gray-500">{customerData.phone}</div>
              )}
              {customerData.email && (
                ...
                paymentData.amountReceived && (
                  <div className="ml-auto text-right">
                    <div className="text-gray-600">
                      Received: $
                      {parseFloat(paymentData.amountReceived).toFixed(2)}
                    </div>
                    <div className="text-green-600 font-medium">
                      Change: $
                      {Math.max(
                        0,
                        parseFloat(paymentData.amountReceived) - totals.total
                      ).toFixed(2)}
                    </div>
                  </div>
                )}
        ...
        {(customerData.notes || paymentData.notes) && (
          <div>
            ...
            <div className="text-sm text-gray-600 space-y-1">
              {customerData.notes && (
                <div>
                  <strong>Order:</strong> {customerData.notes}
                </div>
              )}
              {paymentData.notes && (
                <div>
                  <strong>Payment:</strong> {paymentData.notes}
                </div>
              )}
            </div>
          </div>
