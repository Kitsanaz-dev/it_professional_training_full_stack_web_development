    ...
    switch (paymentData.paymentMethod) {
      ...
      case "card":
        ...
        if (
          ...
          paymentData.cardHolder.trim().length < 2
        ) {
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Please transfer ${total.toFixed(2)} to our bank account. Order
                will be processed upon payment confirmation.
              </p>
            ...
            paymentData.amountReceived && (
              <>
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ${parseFloat(paymentData.amountReceived || 0).toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between">
