  ...
  return (
    <div className="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="relative h-48 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
        ...
        <div
          className="w-full h-full flex items-center justify-center text-gray-400 text-6xl"
        ...
        {/* Stock Badge */}
        <div
          className={`absolute top-3 right-3 px-2.5 py-1 rounded-full text-xs font-medium border ${stockStatus.color} flex items-center space-x-1`}
        >
