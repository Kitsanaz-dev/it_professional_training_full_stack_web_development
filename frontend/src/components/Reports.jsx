        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-green-500 mt-1">↗️ +12% from yesterday</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-blue-500 mt-1">↗️ +8% from yesterday</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-purple-500 mt-1">↗️ +3% from yesterday</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-orange-500 mt-1">↗️ Better than last week</p>
            </div>
            ...
            {salesData.map((day, index) => (
              <div key={day.date} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-900">{day.sales.toLocaleString()} LAK</div>
          ...
          <div className="space-y-4">
            {topProducts.map((product, index) => (
              <div key={product.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <div className="font-medium text-gray-900">{product.sales.toLocaleString()} LAK</div>
                </div>
              </div>
            ))}
          </div>
